...
_KEY_FILES = {"name": os.getenv("HOME") + "/Desktop/facial-recognition/_keys/_embedding_keys.txt",
               "embedding": os.getenv("HOME") + "/Desktop/facial-recognition/_keys/_name_keys.txt"}
_BIT_ENCRYPTION = 16
